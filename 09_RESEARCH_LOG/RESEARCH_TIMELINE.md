...
The five transitions belong to SESSION-022. The former `62a71fcd...` candidate and its `SESSION_023...` file are excluded from canonical authority and are not used as the source of this reconciliation.
